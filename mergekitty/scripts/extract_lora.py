...
from mergekitty.card import generate_card_lora
...
def reconstruct_invocation(args: Dict[str, Any]) -> str:
    ...
    invocation = f"mergekitty-extract-lora {args['finetuned_model']} {args['base_model']} {out_path}"
...
@click.command("mergekitty-extract-lora")
